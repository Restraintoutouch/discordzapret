...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com//"></a><a href="https://github.com//discordzapret">/discordzapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `/discordzapret`, что распространяется от моего лица - **ФЕЙК**.
...
Если этого не произошло, то см. [#522](https://github.com//discordzapret/issues/522)
...
- См. [#765](https://github.com//discordzapret/issues/765)
...
- См. также [#251](https://github.com//discordzapret/discussions/251)
...
- См. также [#252](https://github.com//discordzapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com//discordzapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com//discordzapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com//discordzapret/blob/main/LICENSE.txt)
